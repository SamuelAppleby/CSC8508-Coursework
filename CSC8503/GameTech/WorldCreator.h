...
public:
	...
	static void AddPxRotatingCubeToWorld(const PxTransform& t, const PxVec3 halfSizes, const PxVec3* rotation = new PxVec3(0, 10, 0), float friction = 0.5f, float elasticity = 0.1f, string name = "RotatingCube");
